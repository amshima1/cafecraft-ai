...
analysis only: do not claim to calculate an exact ATS score or predict an ATS
decision. Do not recommend adding a keyword as though the candidate possesses
that skill; flag it for verification when the resume does not support it.
